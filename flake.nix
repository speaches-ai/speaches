      ...
      system: let
        ...
        models = {
          ...
          whisper-base = nix-hug.lib.${system}.fetchModel {
            ...
            repoInfoHash = "sha256-3OJtoPo3Dw2ThF4fuqfbkmtHozVn24R2TYilQByTSqA=";
            fileTreeHash = "sha256-GYgT6udNwSgjZabqajK/i8kL3pvRPbaTC2PQdUfH0EY=";
            derivationHash = "sha256-rSZlNVpVT5fbvIFvoaZZhO7icobKHZdB/QqyBelIGNQ=";
          };
        };
        ...
        packages = {
          ...
          e2e-test = defaultPkgs.writeShellScriptBin "speaches-e2e-test" ''
            ...
            MODEL_CACHE="${nix-hug.lib.${system}.buildCache {
              ...
              hash = "sha256-b4bfr0sXkNm+DmHnt1mZA4xFOG89wXvUWezW5yeqcok=";
            }}"
